...
export function NetworkSettingsPage() {
  ...
  return <div>
    <div className="page-heading">
      ...
      <Button type="primary" icon={<SaveOutlined />} disabled={!data || isError || restarting} loading={mutation.isPending} onClick={() => void save()}>保存配置</Button>
    </div>
    <Space direction="vertical" size={16} style={{ width: '100%' }}>
      ...
      <Form form={form} layout="vertical" disabled={!data || isError || mutation.isPending || restarting} onValuesChange={() => { editVersion.current += 1; }}>
